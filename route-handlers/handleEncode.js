...
const handleEncode = (request, response) => {
    try {
        ...
        response.status(200).send(`Your encode message ==> ${encodedMessage} <br> Copy the below url into your browser to see the decoded version <br>https://chances-enigma-server.herokuapp.com/decode?message=${encodedMessage}`)
    } catch (err) {
