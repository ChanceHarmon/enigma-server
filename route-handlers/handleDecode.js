...
const handleDecode = (request, response) => {
    try {
        ...
        response.status(200).send(`Your decoded message ==> ${decodedMessage} <br> Visit the homepage to get started with another encoded message <br> http://homebasetofollow/`)
    } catch (err) {
